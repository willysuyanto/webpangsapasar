  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-secondary border-right" id="sidebar-wrapper">
      <div class="list-group list-group-flush">
        ...
        <a href="#" class="list-group-item list-group-item-action bg-secondary">Analisa Pangsa Pasar</a>
        <a href="#" class="list-group-item list-group-item-action bg-secondary">Laporan</a>
        <a href="#" class="list-group-item list-group-item-action bg-secondary">Data Siswa</a>
      </div>
    </div>
    <!-- /#sidebar-wrapper -->
